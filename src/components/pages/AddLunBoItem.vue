<template>
    <div class="add_lunbo_item">        
        <div class="addlbitem_content">
            <div class="panel_heading">增加首页轮播图项目</div>
            <div class="form_content">
                <!-- prevent 阻止表单的默认提交行为 -->
                <form @submit.prevent="addLBItem" enctype="multipart/form-data">                    
                    <ul>
                        <li> 
...
<script>
    ...
    import {adminAddItem} from "../../http/index"    
    export default {
        name:"add_lunbo_item",
        data(){
            return {
        ...
        methods:{
            ...
            async addLBItem(){
                ...
                let result = await adminAddItem(data)
                if(result.errCode === 0){
                    // 数据返回成功
                    // 页面跳转
