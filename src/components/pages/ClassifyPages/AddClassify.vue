<template>
    <div class="add_lunbo_item">        
        <div class="addlbitem_content">
            <div class="panel_heading">增加商品分类项目</div>
            <div class="form_content">
                <!-- prevent 阻止表单的默认提交行为 -->
                <form @submit.prevent="addClassifyItem" enctype="multipart/form-data">                    
                    <ul>
                        <li> 
...
<script>
    ...
    import {adminAddClassifyItem} from "../../../http/index"    
    export default {
        name:"add_lunbo_item",
        data(){
            return {
        ...
        methods:{
            ...
            async addClassifyItem(){
                ...
                let result = await adminAddClassifyItem(data)
                if(result.errCode === 0){
                    // 数据返回成功
                    // 页面跳转
...
.add_lunbo_item .addlbitem_content .form_content form ul li input {
